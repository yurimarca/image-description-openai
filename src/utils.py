"""
This module contains utility functions to work with images and text.
Also, it contains a function to produce an image with text for verification 
of LLM's result.
...
def produce_result_sample(image_path: str, text: str, output_img: str):
    ...
    for word in words:
        ...
        text_size = cv2.getTextSize(
            test_line, font, font_scale, font_thickness)[0]
    ...
    line_height = cv2.getTextSize(
        "Test", font, font_scale, font_thickness)[0][1] + 10
    ...
    cv2.rectangle(new_image, (img_width, 0), (img_width +
                  text_box_width, img_height), bg_color, -1)
    ...
    for line in lines:
        cv2.putText(new_image, line, (x_offset, y_offset), font,
